...
foreign import javascript unsafe "transformProperties($1)" js_transform_properties :: JSRef a  -> IO ()

foreign import javascript unsafe "UltraDeepClone($1)" js_ultra_deep_clone :: JSRef a -> IO (JSRef a)
